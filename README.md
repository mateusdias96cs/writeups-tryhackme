[writeups-tryhackme-README.md](https://github.com/user-attachments/files/26435542/writeups-tryhackme-README.md)
# 📝 Writeups — TryHackMe

Repositório com writeups detalhados das rooms que completei no TryHackMe. Cada writeup documenta o raciocínio técnico, ferramentas utilizadas e lições aprendidas durante a resolução.

> *"The best way to learn is to document what you did."*
...
| # | Room | Dificuldade | Técnicas | Status |
|---|---|---|---|---|
| 01 | [🔵 Blue](./blue/README.md) | Fácil | EternalBlue, Metasploit, John the Ripper | ✅ Completo |

> *Novos writeups sendo adicionados regularmente conforme avanço nas rooms.*
